 ...
 */
public class MySqlToMySql_user_1 implements CloudCanalProcessorV2 {

    private DataSource          srcDataSource;

    private final SchemaInfo          factTable             = new SchemaInfo(null, "source", "t_score_info");

    private final SchemaInfo          dimensionTable        = new SchemaInfo(null, "source", "t_user_info");

    private final CustomFieldV2       factTableJoinKey      = CustomFieldV2.buildField("user_id", null, Types.BIGINT, false, false, true);

    private final CustomFieldV2       dimensionTableJoinKey = CustomFieldV2.buildField("id", null, Types.BIGINT, true, false, true);

    private final List<CustomFieldV2> addCols               = new ArrayList<>();
