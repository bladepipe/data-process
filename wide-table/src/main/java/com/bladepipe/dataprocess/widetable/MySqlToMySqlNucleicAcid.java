                ...
                try (ResultSet rcp_tube_patient_rs = rcp_tube_patient_ps.executeQuery()) {
                    while (rcp_tube_patient_rs.next()) {
                        ...
                        if (StringUtils.isNotEmpty(patientId)) {
                            try (Connection rcp_patient_info_conn = srcDataSource.getConnection();
                                    PreparedStatement rcp_patient_info_ps = rcp_patient_info_conn.prepareStatement(patientInfoSql)) {
