...
public class MySqlToMySqlWithDimUpdate_one_fact_one_dim implements CloudCanalProcessorV2 {
    ...
    private final SchemaInfo          factTable             = new SchemaInfo(null, "wide_table", "task_schedule");

    private final SchemaInfo          dimensionTable        = new SchemaInfo(null, "wide_table", "worker");

    private final CustomFieldV2       factTableJoinKey      = CustomFieldV2.buildField("worker_id", null, Types.BIGINT, false, false, true);
