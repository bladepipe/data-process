 ...
 */
public class MySqlToEsOnlyFact_one_fact_two_dim implements CloudCanalProcessorV2 {
    ...
    // 1st dimension table definition
    private final SchemaInfo          dimensionTable_1        = new SchemaInfo(null, "trade", "user");

    // 2nd dimension table definition
    private final SchemaInfo          dimensionTable_2        = new SchemaInfo(null, "trade", "product");

    // 1st dimension table's join key definition in fact table
    private final CustomFieldV2       factTableJoinKey_1      = CustomFieldV2.buildField("user_id", null, Types.BIGINT, false, false, true);

    // 1st dimension table's join key definition in dimension table
    private final CustomFieldV2       dimensionTableJoinKey_1 = CustomFieldV2.buildField("id", null, Types.BIGINT, true, false, true);

    // 2nd dimension table's join key definition in fact table
    private final CustomFieldV2       factTableJoinKey_2      = CustomFieldV2.buildField("product_id", null, Types.BIGINT, false, false, true);

    // 2nd dimension table's join key definition in dimension table
    private final CustomFieldV2       dimensionTableJoinKey_2 = CustomFieldV2.buildField("id", null, Types.BIGINT, true, false, true);

    private final List<CustomFieldV2> addCols_1               = new ArrayList<>();

    private final List<CustomFieldV2> srcCols_1               = new ArrayList<>();

    private final List<CustomFieldV2> srcCols_2               = new ArrayList<>();

    private final List<CustomFieldV2> addCols_2               = new ArrayList<>();
    ...
    public void start(ProcessorContext context) {
        ...
        // columns of 1st dimension table add to fact table ,those definition on dimension table
        srcCols_1.add(CustomFieldV2.buildField("name", null, Types.VARCHAR, false, true, true));

        // columns of 1st dimension table add to fact table ,those definition on fact table
        addCols_1.add(CustomFieldV2.buildField("user_name", null, Types.VARCHAR, false, true, true));

        // columns of 2nd dimension table add to fact table ,those definition on dimension table
        ...
        // columns of 2nd dimension table add to fact table ,those definition on fact table
    ...
    protected void handleFactTable(CustomData data, SchemaInfo dimensionTable, CustomFieldV2 factTableJoinKey, CustomFieldV2 dimensionTableJoinKey, List<CustomFieldV2> addCols,
                                   List<CustomFieldV2> srcCols) {
