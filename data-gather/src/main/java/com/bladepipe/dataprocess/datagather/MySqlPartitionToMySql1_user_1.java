package com.bladepipe.dataprocess.datagather;
...
/**
 * The primary key of the remote end is the primary key of the source end + additional field region.
 * In this way, the purpose of gathering data in many places is not conflicting.
 *
 * @author bucketli 2021/11/29 23:07:26
 */
public class MySqlPartitionToMySql1_user_1 implements CloudCanalProcessorV2 {

    private final SchemaInfo    targetTable = new SchemaInfo(null, "shard_1", "my_order");

    private final CustomFieldV2 region      = CustomFieldV2.buildField("region", "shanghai", Types.VARCHAR, true, false, false);
