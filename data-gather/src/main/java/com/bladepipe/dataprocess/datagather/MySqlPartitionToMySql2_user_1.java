...
public class MySqlPartitionToMySql2_user_1 implements CloudCanalProcessorV2 {
    ...
    private final SchemaInfo    targetTable = new SchemaInfo(null, "shard_2", "my_order");

    private final CustomFieldV2 region      = CustomFieldV2.buildField("region", "hangzhou", Types.VARCHAR, true, false, false);
